...
catalog=(
  ...
  "python-dev-tools|setup-python-dev-tools.sh|python3 -c 'import yaml, httpx, PIL' >/dev/null 2>&1 && command -v uv >/dev/null 2>&1 && command -v ruff >/dev/null 2>&1"
  "shellcheck|setup-shellcheck.sh|command -v shellcheck >/dev/null 2>&1"
  "rsync|setup-rsync.sh|command -v rsync >/dev/null 2>&1"
  "vps-ops-tools|setup-vps-ops-tools.sh|command -v rsync >/dev/null 2>&1 && command -v jq >/dev/null 2>&1 && command -v pv >/dev/null 2>&1 && command -v rg >/dev/null 2>&1 && command -v tcpdump >/dev/null 2>&1"
