"""PIM Email external image transform helpers.

This module is intentionally small and secret-free so helper workers can import
the same JPEG transform logic without loading mailbox, database, or encryption
configuration.
"""
