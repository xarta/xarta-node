...
from .routes_disks import run_disks_offline_browse_reaper
...
from .routes_kanban_postgres import router as kanban_postgres_router
...
from .routes_lxc841_dockge import router as lxc841_dockge_router
...
async def lifespan(application: FastAPI) -> AsyncIterator[None]:
    ...
    # Clean up stale offline VM disk browse sessions after crashes/tab loss.
    disks_offline_browse_reaper_task = asyncio.create_task(run_disks_offline_browse_reaper())
...
def create_app() -> FastAPI:
    ...
    application.include_router(dashboard_auth_router, prefix="/api/v1")
    ...
    application.include_router(lxc841_dockge_router, prefix="/api/v1")
